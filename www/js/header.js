...
export default class MpHeader extends HTMLElement {
        ...
        <header class="mdc-top-app-bar">
            <div class="mdc-top-app-bar__row">
                ...
                <section class="mdc-top-app-bar__section mdc-top-app-bar__section--align-end" role="toolbar">
                    <button class="material-icons mdc-top-app-bar__action-item mdc-icon-button" aria-label="Reload" @click=${() => this.reload()}>loop</button>
    ...
    reload() {
        document.querySelector('mp-status').reloadRadio();
    }
